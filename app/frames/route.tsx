...
const frameHandler = frames(async (ctx) => {
  ...
  try {
    ...
    const shareText = encodeURIComponent(
      `I love looking at charts go up and to the right. Here's a Moxie Fan Token frame to help you share in the enjoyment (or distress).
${displayName}'s Fan Token is now at $${latestPrice.toFixed(
        4
      )} per token. Is it time to send this token higher? Made by @leeknowlton.eth.`
    );
